...
const ComplaintsPage = () => {
  ...
  const viewComplaintDetails = async (complaintId) => {
    try {
      ...
      showToast(err.response?.data?.message || 'Failed to fetch complaint details', 'error');
    }
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold">FAQ & Policies</h3>
          </div>
          <p className="text-gray-600 mb-4">Find answers to common questions about refunds, cancellations, and safety policies.</p>
          <button className="text-blue-600 hover:text-blue-800 font-medium">View FAQs</button>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="flex space-x-4">
            <button className="text-green-600 hover:text-green-800 font-medium">Chat Now</button>
            <button className="text-green-600 hover:text-green-800 font-medium">Call Support</button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">My Complaint Tickets</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-200">
            {complaints.map((complaint) => (
              <div key={complaint._id} className="p-6 hover:bg-gray-50 transition-colors duration-150">
                <div className="flex justify-between">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Complaint #{complaint._id.substring(0, 8)}</h3>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border ${formErrors.bookingId ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border ${formErrors.message ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
            ...
            <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
              ...
              <button
                ...
                className={`px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${!formData.bookingId || !formData.message ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
              >
                Submit Complaint
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-screen overflow-y-auto">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h4 className="text-md font-medium text-gray-900 mb-3">Complaint Information</h4>
              ...
              <div className="mb-6">
                <h4 className="text-md font-medium text-gray-900 mb-3">Complaint Message</h4>
              ...
              {selectedComplaint.imageUrl && (
                <div className="mb-6">
                  <h4 className="text-md font-medium text-gray-900 mb-3">Image Proof</h4>
              ...
              {selectedComplaint.responseByAdmin && (
                <div className="mb-6">
                  <h4 className="text-md font-medium text-gray-900 mb-3">Admin Response</h4>
              ...
              {selectedComplaint.status === 'resolved' && (
                <div className="mb-6">
                  <h4 className="text-md font-medium text-gray-900 mb-3">Reopen Complaint</h4>
                  <textarea
                    rows="3"
                    value={reopenReason}
